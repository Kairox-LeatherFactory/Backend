...
from app.modules.procurement import po_costing, po_presenters as present, po_tracking
...
from app.modules.procurement.escalation import get_escalation_transport
...
from app.modules.procurement.notifier import get_notifier
from app.modules.procurement.po_export import DEFAULT_TEMPLATE_CFG, render_po_pdf
from app.modules.procurement.repository import ProcurementRepository
from app.modules.procurement.storage import get_storage
...
def _po_template_cfg(supplier_type: str | None) -> dict:
    ...
    from app.modules.procurement.po_templates import template_cfg_for
...
class PoService:
    ...
    async def generate_for_bom(self, user, bom_id: uuid.UUID) -> dict:
        from app.modules.procurement.supplier_service import SupplierService
    ...
    async def _on_po_raised(self, po) -> None:
        try:
            from app.modules.procurement.production_tracking_service import (
